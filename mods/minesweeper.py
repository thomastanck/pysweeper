...
# boardmanager: when tile clicked, if it is not a mine, calculate cells that need to be determined. determine them, then reveal the cell that the player just clicked (calculate the number). the click goes in the vid file. if it is a mine, determine the rest of the board and show face blast and all that jazz.
...
# f2: same as above.
    ...
    def press_smiley(self, hn, e):
        # TODO: implement smiley presses in BoardManager
        # TODO: hell, implement EVERYTHING in BoardManager then rename it GameDisplayManager!
